...
//utility method for SendKeys
	...
	public static String Test_Configeration() throws IOException {
		String filepath="./src/test/resources/Test_Configeration/TestConfigeration.properties";
	...
	public static Object[][] get_Test_Data(String sheetname) throws IOException {
		String filepath="./Test_Data/vtiger.xlsx";
		FileInputStream fis=new FileInputStream(filepath);
	...
	public static void take_screeshot() throws IOException {
...
//		TakesScreenshot ts=(TakesScreenshot)driver;
//		File ss=ts.getScreenshotAs(OutputType.FILE);
//		File destination=new File("./Take_screenshot/Take_screenshot.png");
//		FileHandler.copy(ss,destination);
